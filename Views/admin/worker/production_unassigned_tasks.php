...
<body>
    ...
    <div class="main">
        ...
        <section class="task-info">
            <h2>list of unassigned tasks for production department</h2>
                    ...
                    <?php if($tasks) : ?>
                        <?php foreach($tasks as $task) : ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn assign-btn" href="/netclive-task-assignment-application/public/?worker/show+assign+task+form/<?php echo $task->id; ?>">assign</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
